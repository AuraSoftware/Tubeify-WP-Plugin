(function() {
	...
	tinymce.PluginManager.add('videojs', tinymce.plugins.tb_player);
	...
	jQuery(function() {
		...
		<div id="bz-block" class="form-table">\
			  ...
			  <section id="content2">\
			    <div class="bz-title">Video Playlist</div>\
			    <div class="bz-body"><input type="text" placeholder="Playlist URL" name="videojs-playlist" id="videojs-playlist"></div>\
				...
				<div class="b-block">\
					<div class="bz-title inline"><label for="videojs-thumbnails"><span class="dashicons dashicons-images-alt"></span>Thumbnails</div>\
					<div class="bz-body"><input id="videojs-thumbnails" name="videojs-thumbnails" type="checkbox" /></div>\
				</div>\
			  </section>\
			  <section id="content4">\
				<div class="bz-title">flv</div>\
					<div class="bz-body"><input type="text" placeholder="Main URL" name="videojs-flv" id="videojs-flv"></div>\
					<div class="bz-body label"><input type="text" placeholder="Label" name="videojs-flv_label" id="videojs-flv_label"></div>\
					<div class="bz-body"><input type="text" placeholder="2 URL" name="videojs-flv_2" id="videojs-flv_2"></div>\
					<div class="bz-body label"><input type="text" placeholder="Label" name="videojs-flv_2_label" id="videojs-flv_2_label"></div>\
					<div class="bz-body"><input type="text" placeholder="3 URL" name="videojs-flv_3" id="videojs-flv_3"></div>\
					<div class="bz-body label"><input type="text" placeholder="Label" name="videojs-flv_3_label" id="videojs-flv_3_label"></div>\
					<div class="bz-body"><input type="text" placeholder="4 URL" name="videojs-flv_4" id="videojs-flv_4"></div>\
					<div class="bz-body label"><input type="text" placeholder="Label" name="videojs-flv_4_label" id="videojs-flv_4_label"></div>\
					<div class="bz-body"><input type="text" placeholder="5 URL" name="videojs-flv_5" id="videojs-flv_5"></div>\
					<div class="bz-body label"><input type="text" placeholder="Label" name="videojs-flv_5_label" id="videojs-flv_5_label"></div>\
					<div class="bz-body"><input type="text" placeholder="6 URL" name="videojs-flv_6" id="videojs-flv_6"></div>\
					<div class="bz-body label"><input type="text" placeholder="Label" name="videojs-flv_6_label" id="videojs-flv_6_label"></div>\
			  ...
			  <section id="content5">\
				<div class="bz-title">Social Media Source Url</div>\
					<div class="bz-body"><input type="text" placeholder="Youtube Video URL" name="videojs-youtube" id="videojs-youtube"></div>\
					<div class="bz-body"><input type="text" placeholder="Wistia Video URL" name="videojs-wistia" id="videojs-wistia"></div>\
					<div class="bz-body"><input type="text" placeholder="Dailymotion Video URL" name="videojs-dailymotion" id="videojs-dailymotion"></div>\
					<div class="bz-body"><input type="text" placeholder="Dailymotion Video Option 2" name="videojs-dailymotion2" id="videojs-dailymotion2"></div>\
					<div class="bz-body"><input type="text" placeholder="Twitch Tv Video URL" name="videojs-twitch" id="videojs-twitch"></div>\
					<div class="bz-body"><input type="text" placeholder="Twitter Video URL" name="videojs-twitter" id="videojs-twitter"></div>\
					<div class="bz-body"><input type="text" placeholder="Tiktok Video URL" name="videojs-tiktok" id="videojs-tiktok"></div>\
					<div class="bz-body"><input type="text" placeholder="Instagram Video URL" name="videojs-instagram" id="videojs-instagram"></div>\
					<div class="bz-body"><input type="text" placeholder="Vimeo Video URL" name="videojs-vimeo" id="videojs-vimeo"></div>\
					<div class="bz-body"><input type="text" placeholder="Facebook Video URL" name="videojs-facebook" id="videojs-facebook"></div>\
			  ...
			  <section id="content7">\
				<div class="bz-title inline"><label for="videojs-sp_preroll"><span class="dashicons dashicons-controls-repeat"></span>Video Intro</div>\
			  ...
			  <section id="content8">\
				...
				<div class="b-block">\
					<div class="bz-info"><span>Video Playlist Implement</span> - Need following methods for implement.</div>\
				</div>\
				<div class="b-block">\
				...
				<div class="b-block">\
					<div class="bz-info"><span>Thumbnails Preview</span> - WebVTT Format is supported.</div>\
				</div>\
				<div class="b-block">\
					<div class="bz-info"><span>Video intro</span> - Only for Mp4 videos, for enabling video Intro check feature and fill all its fields.</div>\
				</div>\
			 </section>\
			<div class="b-block">\
