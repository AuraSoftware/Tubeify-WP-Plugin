...
function tbplayer_menu() {
	global $tbplayer_admin;
	$tbplayer_admin = add_menu_page('Tubeify Panel', 'Tubeify Panel', 'manage_options', 'tbplayer', 'tbplayer_settings', plugins_url('icon.png', __FILE__));
}
add_action('admin_menu', 'tbplayer_menu');

function tbplayer_settings() {
	if (!current_user_can('manage_options'))  {
		wp_die( __('You do not have sufficient permissions to access this page.') );
	}
	?>
	<div class="wrap" style=" margin: 30px; background: #fff; padding: 30px; border-radius: 10px; ">
	<img src="<?php echo ''. plugins_url( 'tbplayer.png' , __FILE__ ) .''; ?>"></img></br>
	<span>

		

 <b>*** Note: if you are choosing feature for example - "Brand/logo" you must fill all its fields:Image URL, Click Target, otherwise you'll get some errors.**</b>
		<hr>


	<li><b>PLAYER OPTIONS</b></li>
	<li>PLAYER OPTIONS- For Config/Enable Player button</li>
	<li><b>ADVERTISMENT</b></li>
	<li>Enable Ads and Place Ads Tags</li>
	<li><b>PLAYER CONTROLS</b></li>
	<li>Enable To enable basic player parameters</li>
	<li><b>PLAYER THEMES</b></li>
	<li>Select your Desire Theme</li>

	<li><b>THEME BUILDER</b></li>
	<li>This allowed you to make your theme colorful / Well as apply changes to Selected ,<br/>  Theme you have choosen above</li>
    <hr>
	 </span>
...
add_action('admin_init', 'register_tbplayer_settings');

/* Settings */
function register_tbplayer_settings() {
	register_setting('videojs_options', 'videojs_options', 'tbplayer_options_validate');

	add_settings_section('videojs_options', 'PLAYER OPTIONS', 'tbplayer_output', 'videojs-settings');
	...
	add_settings_field('videojs_res', 'Resolution Button', 'res_output', 'videojs-settings', 'videojs_options');
	...
	add_settings_field('videojs_dvr', 'DVR function', 'dvr_output', 'videojs-settings', 'videojs_options');	
	...
	add_settings_section('videojs_ads', 'ADVERTISMENT', 'tbplayer_output', 'videojs-settings');
	...
	add_settings_section('videojs_controls', 'PLAYER CONTROLS', 'tbplayer_output', 'videojs-settings');
	...
	add_settings_section('videojs_themes', 'PLAYER THEMES', 'tbplayer_output', 'videojs-settings');
	...
	add_settings_section('videojs_theme', 'THEME BUILDER', 'tbplayer_output', 'videojs-settings');
...
/* Inputs */
function tbplayer_options_validate($input) {
	...
	$newinput['videojs_res'] = $input['videojs_res'];
	...
	$newinput['videojs_dvr'] = $input['videojs_dvr'];
...
function dvr_output() {
	$options = get_option('videojs_options');
	if($options['videojs_dvr']) { $checked = ' checked="checked" '; } else { $checked = ''; }
	echo "<input ".$checked." id='videojs_dvr' name='videojs_options[videojs_dvr]' type='checkbox' />";
}
...
function add_defaults_fn() {
	$tmp = get_option('videojs_options');
		...
		$arr = array("videojs_height"=>"264","videojs_width"=>"640","videojs_default"=>"on","videojs_reset"=>"");
